...
| Kind | service |
| Language | go-module |
| Root Path | `coordinator/cmd/coordinator` |
| Manifest | `coordinator/go.mod` |
| Internal Deps | coordinator |
| External Apps | postgresql, stripe, datadog, privy, apple-secure-enclave, cloudflare-r2 |

> Central control plane for routing AI inference requests to provider nodes with hardware attestation
